...
import image.multimodal_chatbot_lib as glib #reference to local lib script



st.set_page_config(page_title="Multimodal Chatbot",layout="wide") #HTML title
...
with col4:
    clear_chat = st.button("Clear Chat History",on_click=form_callback)
