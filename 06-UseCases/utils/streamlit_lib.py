...
def tune_parameters():
    ...
    with st.form(key ='form2'):
        ...
        if provider in ['Anthropic', 'AI21', 'Cohere', 'Meta']:
            top_k=st.slider('topK', min_value = 50, max_value = 200, value = 100, step = 1)
    ...
    match provider:
        case 'Anthropic':
            return temperature, top_p, top_k, max_tokens, model_id, submit, provider
        case 'AI21':
