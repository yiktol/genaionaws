...
def image_parameters():
    ...
    cfg_scale = st.slider('cfg_scale', value=10,
                          min_value=1, max_value=35, step=1)
...
def get_image_from_model(prompt, model, negative_prompt=None, **params):

    body = get_sdxl_image_generation_request_body(
