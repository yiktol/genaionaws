...
input_text:str = "What are the open claims?" # replace this with a prompt relevant to your agent
agent_id:str = 'PWLBD9KGPI' # note this from the agent console on Bedrock
...
st.write("Insurance Claim Agent with KnowledgeBase")

with st.expander(":orange[See Architeture]"):
    st.image("images/93-agent-architecture.png")
with st.expander(":orange[See Workflow]"):
    st.image("images/93-agent-workflow.png")


if 'chat_history' not in st.session_state: #see if the chat history hasn't been created yet
    st.session_state.chat_history = [{"role": "assistant", "text": "Hi, I'm an Insurance Claim Agent. How may I assist you today?"}]
