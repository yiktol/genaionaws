...
llm = Bedrock(client=bedrock, model_id="amazon.titan-tg1-large")
...
prompt = "A sample SSN number looks like this 123-22-3345. Can you give me some more samples?"
...
def invoke_chain(submit, prompt_data):
    if submit:
...
options = [{"id":1,"prompt": prompt3,"system": "","height":600},
           {"id":2,"prompt": prompt,"system": "","height":100},
...
- Prompt Safety detection
        ...
        try:
            ...
            invoke_chain(submit, prompt_data)
